;(function (root, factory) {
    ...
    MOJFrontend.FormValidator.prototype.getSummaryHtml = function () {
        ...
        for (var i = 0, j = this.errors.length; i < j; i++) {
            ...
            html += '<li>';
            html += '<a id="error-summary-' + this.escapeHtml(error.fieldName) +  '" href="#' + this.escapeHtml(error.fieldName) + '">';
    ...
    MOJFrontend.FormValidator.prototype.showInlineError = function (error) {
        var errorSpanId = error.fieldName;
        var errorMessage = $('#error-message-' + error.fieldName).text();
        $('#error-summary-' + error.fieldName).text(errorMessage);
        ...
        $('#errorSummary-' + error.fieldName).show();
    };
    ...
    MOJFrontend.FormValidator.prototype.removeInlineError = function (error) {
        ...
        //$('#errorSummary').hide();
        $('#errorSummary-' + error.fieldName).hide();
    };
