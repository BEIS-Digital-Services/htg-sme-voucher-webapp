...
{
    [TestFixture]
    public class BR07Test
    {
        private Mock<ILogger<BR07>> _mockLogger;
        private BR07 _sut;
        ...
        public void Setup()
        {
            _mockLogger = new Mock<ILogger<BR07>>();
            _sut = new BR07(_mockLogger.Object, new DirectorDisqualification());
        ...
        [Test]
        public void NoDirectorDisqualification()
        {
            _indesserCompanyResponse.Characteristics.Add(new Services.Connectors.Domain.Characteristic { Name = Characteristics.DirectorDisqualification, Value = "0" });            
        ...
        [Test]
        public void FoundDirectorDisqualification()
        {
            _indesserCompanyResponse.Characteristics.Add(new Services.Connectors.Domain.Characteristic { Name = Characteristics.DirectorDisqualification, Value = "1" });
